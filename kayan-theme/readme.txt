...
= 2.4.7 =
* دمج خط Montserrat Arabic + تعريب منصة كيان مع واجهة SEO/التتبع.
* توسيع ترجمة لوحة كيان لتغطية كل وحدات المنصة تقريباً.
* تعريب قائمة وتتبع كيان (KAYAN Track).

= 2.4.5 =
* خط Montserrat Arabic (YourColor) على كامل لوحة تحكم ووردبريس: القائمة، شريط الأدمن، المقالات، الخدمات، التصنيفات، منصة كيان.
