...
class Kayan_Compatibility_Report {
	...
	private function systems() {
		...
		return array(
			...
			array(
				'name'      => 'Programmatic SEO Platform (complete)',
				'path'      => 'includes/pseo/',
				'status'    => 'Already compatible',
				'risk'      => 'Low',
				'adapter'   => '',
				'summary'   => 'Phase 4 completed generation (Generator/Queue/Scheduler/Renderer). Prefers existing CPTs (services/faqs/pricing); only true multi-entity combinations use the kayan_pseo host type. Every write is fingerprint-keyed — never changes an existing post\'s URL.',
				'migration' => 'No action required. Bulk-generate only via reviewed Rules; always Preview before Bulk Generate in production.',
				'notes'     => 'Rank Math remains the only SEO engine — the Generator only writes RM\'s own postmeta fields.',
			),
			array(
				'name'      => 'Admin Platform Core (complete)',
				'path'      => 'includes/admin/',
				'status'    => 'Already compatible',
				'risk'      => 'Low',
				'adapter'   => 'admin_bridges',
				'summary'   => 'Phases 3–5 completed Dashboard, Navigation, Settings, Countries, Languages, Entities, Relationships, Permissions, Logs, System Health, Import/Export, Rank Math Integration, Templates, Blueprints, Blocks, Programmatic SEO, Queue, and AI. Media/Analytics/Performance/Security remain placeholder shells (out of the approved roadmap).',
				'migration' => 'Register future UIs only through `kayan_admin()` when approved.',
				'notes'     => '',
			),
			array(
				'name'      => 'Migration & Version Engine',
				'path'      => 'includes/migration/',
				'status'    => 'Already compatible',
				'risk'      => 'Low',
				'adapter'   => '',
				'summary'   => 'New in Phase 4. Additive only — existing booking/payment/track ad-hoc version checks are untouched and continue to work exactly as before.',
				'migration' => 'No action required. Other packs may adopt `kayan_migrations_register` later; nothing is forced.',
				'notes'     => '',
			),
			array(
				'name'      => 'AI Platform / Content Workflow / Quality Engine / Dependency Graph',
				'path'      => 'includes/ai/, includes/workflow/, includes/quality/, includes/dependency/',
				'status'    => 'Already compatible',
				'risk'      => 'Low',
				'adapter'   => '',
				'summary'   => 'New in Phase 5. Only affect posts carrying a PSEO fingerprint/blueprint (i.e. platform-generated pages). Manually authored content, and every pre-existing pack, is completely unaffected — verified by automated tests confirming a manually created post has no workflow/quality/dependency footprint.',
				'migration' => 'Configure an AI provider (optional) at KAYAN → AI to enable block regeneration/translation. Safe to leave unconfigured.',
				'notes'     => '',
			),
		);
	}
