	...
	private function systems() {
		...
		return array(
			...
			array(
				...
				'risk'      => 'Low',
				'adapter'   => 'admin_bridges',
				'summary'   => 'Platform Country/Language engines + kayan-i18n routing ownership already integrated. Admin shells bridge to existing YTS — no new locale UIs.',
				'migration' => 'Continue configuring via Theme Options / i18n options until a later approved UI phase.',
				'notes'     => '',
			),
			array(
			...
			array(
				...
				'risk'      => 'Low',
				'adapter'   => 'admin_bridges',
				'summary'   => 'Existing menus remain. Admin Platform module shells link to those screens instead of inventing replacements.',
				'migration' => 'Operators keep using existing menus. Platform admin is additive shell only.',
				'notes'     => '',
			),
			array(
			...
			array(
				...
				'risk'      => 'Low',
				'adapter'   => 'admin_bridges',
				'summary'   => 'Phase 3.0 shells retained. Bridges prevent empty modules from looking like missing features.',
